#
#  Be sure to run `pod spec lint PLUUIComponents.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/LongzhuLive/PLUDiagnose.git", :tag => "#{s.version}" }
  ...
  #
    ...
    s.requires_arc = true
    s.ios.vendored_frameworks = "PLUDiagnose.framework"
  ...
  #
    ...
    s.resource  = "PLUDiagnose.framework/*.bundle"
